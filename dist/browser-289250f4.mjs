import { aV as bt, aW as Pt } from "./index-560d1e7a.mjs";
var O = {}, Rt = function() {
...
(function(e) {
  ...
  e.isValid = function(n) {
    ...
    for (let A = 0; A < r; A++) {
      ...
      for (let w = 0; w < r; w++) {
        let g = n.get(A, w);
        g === l ? c++ : (c >= 5 && (s += t.N1 + (c - 5)), l = g, c = 1), g = n.get(w, A), g === a ? u++ : (u >= 5 && (s += t.N1 + (u - 5)), a = g, u = 1);
      }
    ...
    for (let c = 0; c < r - 1; c++)
      for (let u = 0; u < r - 1; u++) {
        const l = n.get(c, u) + n.get(c, u + 1) + n.get(c + 1, u) + n.get(c + 1, u + 1);
        (l === 4 || l === 0) && s++;
      }
    return s * t.N2;
    ...
    for (let l = 0; l < r; l++) {
      c = u = 0;
      for (let a = 0; a < r; a++)
        c = c << 1 & 2047 | n.get(l, a), a >= 10 && (c === 1488 || c === 93) && s++, u = u << 1 & 2047 | n.get(a, l), a >= 10 && (u === 1488 || u === 93) && s++;
    }
    return s * t.N3;
  ...
  e.applyMask = function(n, r) {
    ...
    for (let l = 0; l < s; l++) {
      r(l), e.applyMask(l, n);
      const a = e.getPenaltyN1(n) + e.getPenaltyN2(n) + e.getPenaltyN3(n) + e.getPenaltyN4(n);
      e.applyMask(l, n), a < u && (u = a, c = l);
    }
    return c;
  };
})(Et);
...
st.prototype.encode = function(t) {
  ...
  i.set(t);
  const o = yt.mod(i, this.genPoly), n = this.degree - o.length;
  if (n > 0) {
...
S.KANJI = new RegExp(H, "g");
S.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g");
S.BYTE = new RegExp(Vt, "g");
S.NUMERIC = new RegExp(At, "g");
S.ALPHANUMERIC = new RegExp(zt, "g");
const Ht = new RegExp("^" + H + "$"), Kt = new RegExp("^" + At + "$"), Jt = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
(function(e) {
  const t = T, i = j, o = G, n = L, r = ut, s = 7973, c = t.getBCHDigit(s);
  function u(w, g, E) {
    for (let C = 1; C <= 40; C++)
  ...
  function l(w, g) {
    return n.getCharCountIndicator(w, g) + 4;
  }
  function a(w, g) {
    let E = 0;
  ...
  function A(w, g) {
    for (let E = 1; E <= 40; E++)
      if (a(w, E) <= e.getCapacity(E, g, n.MIXED))
        return E;
  }
  e.from = function(g, E) {
    return r.isValid(g) ? parseInt(g, 10) : E;
...
var It = {};
const et = T, Nt = 1335, Yt = 21522, ft = et.getBCHDigit(Nt);
It.getEncodedBits = function(t, i) {
  const o = t.bit << 3 | i;
  let n = o << 10;
  for (; et.getBCHDigit(n) - ft >= 0; )
    n ^= Nt << et.getBCHDigit(n) - ft;
  return (o << 10 | n) ^ Yt;
};
var Tt = {};
const $t = L;
...
const jt = bt, vt = L;
function F(e) {
  this.mode = vt.BYTE, typeof e == "string" && (e = jt(e)), this.data = new Uint8Array(e);
}
...
const Wt = L, qt = T;
function k(e) {
  this.mode = Wt.KANJI, this.data = e;
}
...
var Zt = k;
(function(e) {
  const t = L, i = _t, o = Gt, n = Qt, r = Zt, s = S, c = T, u = Pt;
  function l(h) {
  ...
  function A(h) {
    ...
    let f, y;
    return c.isKanjiModeEnabled() ? (f = a(s.BYTE, t.BYTE, h), y = a(s.KANJI, t.KANJI, h)) : (f = a(s.BYTE_KANJI, t.BYTE, h), y = []), m.concat(d, f, y).sort(function(I, p) {
  ...
  function C(h, m) {
    ...
    for (let B = 0; B < h.length; B++) {
      ...
      for (let P = 0; P < I.length; P++) {
        const M = I[P], z = "" + B + P;
        p.push(z), d[z] = { node: M, lastCount: 0 }, f[z] = {};
        for (let W = 0; W < y.length; W++) {
          const b = y[W];
          d[b] && d[b].node.mode === M.mode ? (f[b][z] = w(d[b].lastCount + M.length, M.mode) - w(d[b].lastCount, M.mode), d[b].lastCount += M.length) : (d[b] && (d[b].lastCount = M.length), f[b][z] = w(M.length, M.mode) + 4 + t.getCharCountIndicator(M.mode, m));
        }
      }
      y = p;
    }
 ...
 Suggested mode is: ` + t.toString(f));
  ...
  e.fromArray = function(m) {
    ...
    const f = A(m, c.isKanjiModeEnabled()), y = E(f), B = C(y, d), I = u.find_path(B.map, "start", "end"), p = [];
    for (let P = 1; P < I.length - 1; P++)
      p.push(B.table[I[P]].node);
    return e.fromArray(g(p));
...
const Q = T, Z = G, Xt = Ut, xt = Dt, te = wt, ee = mt, nt = Et, ot = j, ne = kt, _ = Bt, oe = It, re = L, X = Tt;
function ie(e, t) {
...
function x(e, t, i) {
  const o = e.size, n = oe.getEncodedBits(t, i);
  let r, s;
  for (r = 0; r < 15; r++)
    ...
    for (c === 6 && c--; ; ) {
      for (let u = 0; u < 2; u++)
        if (!e.isReserved(n, c - u)) {
          let l = !1;
          s < t.length && (l = (t[s] >>> r & 1) === 1), e.set(n, c - u, l), r--, r === -1 && (s++, r = 7);
        }
      if (n += o, n < 0 || i <= n) {
        n -= o, o = -o;
        break;
...
function ae(e, t, i) {
  ...
  i.forEach(function(u) {
    o.put(u.mode.bit, 4), o.put(u.getLength(), re.getCharCountIndicator(u.mode, e)), u.write(o);
  });
...
function fe(e, t, i) {
  const o = Q.getSymbolTotalCodewords(t), n = ot.getTotalCodewordsCount(t, i), r = o - n, s = ot.getBlocksCount(t, i), c = o % s, u = s - c, l = Math.floor(o / s), a = Math.floor(r / s), A = a + 1, w = l - a, g = new ne(w);
  let E = 0;
  ...
  for (let I = 0; I < s; I++) {
    const p = I < u ? a : A;
    C[I] = m.slice(E, E + p), N[I] = g.encode(C[I]), E += p, h = Math.max(h, p);
  }
...
function ge(e, t, i, o) {
  ...
  if (Array.isArray(e))
    ...
    n = X.fromString(e, l || 40);
  } else
    throw new Error("Invalid data");
  const r = _.getBestVersionForData(n, i);
  if (!r)
...
dt.create = function(t, i) {
  ...
  let o = Z.M, n, r;
  return typeof i < "u" && (o = Z.from(i.errorCorrectionLevel, Z.M), n = _.from(i.version), r = nt.from(i.maskPattern), i.toSJISFunc && Q.setToSJISFunction(i.toSJISFunc)), ge(t, n, o, r);
};
var pt = {}, ct = {};
(function(e) {
  function t(i) {
  ...
  e.getOptions = function(o) {
    ...
    const s = n.modules.size, c = n.modules.data, u = e.getScale(s, r), l = Math.floor((s + r.margin * 2) * u), a = r.margin * u, A = [r.color.light, r.color.dark];
    for (let w = 0; w < l; w++)
      for (let g = 0; g < l; g++) {
        let E = (w * l + g) * 4, C = r.color.light;
...
(function(e) {
  ...
  e.render = function(r, s, c) {
    ...
    const a = t.getImageWidth(r.modules.size, u), A = l.getContext("2d"), w = A.createImageData(a, a);
    return t.qrToImageData(w.data, r, u), i(A, l, a), A.putImageData(w, 0, 0), l;
  }, e.renderToDataURL = function(r, s, c) {
    let u = c;
    typeof u > "u" && (!s || !s.getContext) && (u = s, s = void 0), u || (u = {});
    const l = e.render(r, s, u), a = u.type || "image/png", A = u.rendererOpts || {};
...
function he(e, t, i) {
  ...
  for (let c = 0; c < e.length; c++) {
    ...
    !u && !r && (r = !0), e[c] ? (s++, c > 0 && u > 0 && e[c - 1] || (o += r ? tt("M", u + i, 0.5 + l + i) : tt("m", n, 0), n = 0, r = !1), u + 1 < t && e[c + 1] || (o += tt("h", s), s = 0)) : n++;
  }
  return o;
}
...
O.create = rt.create;
O.toCanvas = lt.bind(null, St.render);
O.toDataURL = lt.bind(null, St.renderToDataURL);
